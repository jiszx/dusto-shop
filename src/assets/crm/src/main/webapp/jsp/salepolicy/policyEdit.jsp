...
<body class="container-fluid content">
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" action="salePolicy/editPolicyLine" id="addDZPromotionForm">
						<div class="form-group  ">
							...
							<div class=" col-sm-5">
								...
								<select class="form-control" data-placeholder="请选择SKU..."	 name="materialId"	id="dzmaterialId">
								</select>
							</div>
							<input type="hidden" name="headerId" value="${policy.id}">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-dz-save btn-primary" form="addDZPromotionForm">确认添加</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
	...
	<%-- modal 修改搭赠销售政策 --%>
	<div class="modal fade" id="editdzPolicyModal" tabindex="-1" role="dialog">
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<h4 class="modal-title">修改搭赠销售政策</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" action="salePolicy/editPolicyLine" id="editDZPromotionForm">
						<div class="form-group  ">
							<label for="materialId" class=" col-sm-3 control-label">订单SKU：</label>
							<div class=" col-sm-5">
								<!-- <select class="form-control" data-placeholder="请选择SKU..."
								...
								<select class="form-control" data-placeholder="请选择SKU..."	 name="materialId"	id="editdzmaterialId">
								</select>
							</div>
							<input type="hidden" name="headerId" value="${policy.id}">
							<input type="hidden" name="id" id="editdzid">
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="discount" class="col-sm-3 control-label">单位:</label>
							<div class=" col-sm-5">
								<input type="text" class="form-control" 
									id="editdzunit" readonly="readonly">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							...
							<div class=" col-sm-5">
								<input type="text" class="form-control" 
									id="editdzprice" readonly="readonly">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="discount" class="col-sm-3 control-label">搭增SKU：</label>
							<div class=" col-sm-5">
								<select class="form-control" name="discount" id="editdzdiscount">
								</select>
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="primary" class="col-sm-3 control-label ">目标数量：</label>
							<div class="col-sm-5">
								<input type="text" class="  form-control" id="editdzprimary"
									name="primary" placeholder="搭增标准">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="discountIntensity" class="col-sm-3  control-label">搭增数量：</label>
							<div class=" col-sm-5">
								<input type="text" class="form-control" id="editdzdiscountIntensity"
									name="discountIntensity" placeholder="搭增数量">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="limit" class="col-sm-3 control-label ">搭增限量：</label>
							<div class=" col-sm-5">
								<input type="text" class="form-control" id="editdzlimit"
									name="limit" placeholder="搭增限额">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="submit" class="btn btn-dz-edit btn-primary" form="editDZPromotionForm">确认</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
	...
	<div class="modal fade" id="zkPolicyModal" tabindex="-1" role="dialog">
		<div class="modal-dialog ">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" action="salePolicy/editPolicyLine"  id="addZKPromotionForm">
						<div class="form-group  ">
						...
						<div class="form-group  ">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="zkdiscountIntensity" name="discountIntensity"
									placeholder="折扣：90%/9折"><span class="input-group-addon">%</span>
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="submit" class="btn btn-zk-save btn-primary" form="addZKPromotionForm"	>确认添加</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
	...
	<%-- modal 修改价格折扣销售政策 --%>
	<div class="modal fade" id="editzkPolicyModal" tabindex="-1" role="dialog">
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<h4 class="modal-title">修改价格折扣销售政策</h4>

				</div>
				<div class="modal-body">
					<form class="form-horizontal" action="salePolicy/editPolicyLine"  id="editZKPromotionForm">
						<div class="form-group  ">
							<label for="input1" class="col-sm-3  control-label">订单SKU：</label>
							<div class="col-sm-5">
								<select class="form-control" name="materialId" id="editzkmaterialId">
								</select>
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<input type="hidden" name="headerId" value="${policy.id}">
						<input type="hidden" name="id" id="editzkid">
						<div class="form-group  ">
							<label for="discount" class="col-sm-3 control-label">单位:</label>
							<div class=" col-sm-5">
								<input type="text" class="form-control"
									id="editzkunit" readonly="readonly">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							...
							<div class=" col-sm-5">
								<input type="text" class="form-control" 
									id="editzkprice" readonly="readonly">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<input type="hidden" name="discount" value="2">
						<div class="form-group  ">
							<label for="input1" class=" col-sm-3 control-label">折扣：</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="editzkdiscountIntensity" name="discountIntensity"
									placeholder="折扣：90%/9折"><span class="input-group-addon">%</span>
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="submit" class="btn btn-zk-edit btn-primary" form="editZKPromotionForm">确认</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
	...
	<div class="modal fade" id="jhPolicyModal" tabindex="-1" role="dialog">
		<div class="modal-dialog ">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" action="salePolicy/editPolicyLine"  id="addJHPromotionForm">
						<div class="form-group  ">
						...
						<div class="form-group  ">
							<label for="discount" class="col-sm-3 control-label">单位:</label>
							<div class=" col-sm-5">
								<input type="text" class="form-control"  id="jhunit"
									readonly="readonly">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						...
						<input type="hidden" name="discount" value="4">
						<div class="form-group  ">
							<label for="input1" class=" col-sm-3 control-label">奖励比例：</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="jhdiscountIntensity" name="discountIntensity"
									placeholder="返点：1%"><span class="input-group-addon">%</span>
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="submit" class="btn btn-jh-save btn-primary" form="addJHPromotionForm">确认添加</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
	...
	<!-- /.modal -->
	<%-- modal 修改进货奖励销售政策 --%>
	<div class="modal fade" id="editjhPolicyModal" tabindex="-1" role="dialog">
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<h4 class="modal-title">修改返利销售政策</h4>

				</div>
				<div class="modal-body">
					<form class="form-horizontal" action="salePolicy/editPolicyLine"  id="editJHPromotionForm">
						<div class="form-group  ">
							<label for="input1" class="col-md-3  control-label">订单SKU：</label>
							<div class="col-md-5">
								<select class="form-control" name="materialId" id="editjhmaterialId">
								</select>
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<input type="hidden" name="headerId" value="${policy.id}">
						<input type="hidden" name="id" id="editjhid">
						<div class="form-group  ">
							<label for="discount" class="col-sm-3 control-label">单位:</label>
							<div class=" col-sm-5">
								<input type="text" class="form-control"  id="editjhunit"
									readonly="readonly">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							...
							<div class=" col-sm-5">
								<input type="text" class="form-control" 
									id="editjhprice" readonly="readonly">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<input type="hidden" name="discount" value="4">
						<div class="form-group  ">
							<label for="input1" class=" col-sm-3 control-label">奖励比例：</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="editjhdiscountIntensity" name="discountIntensity"
									placeholder="返点：1%"><span class="input-group-addon">%</span>
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="submit" class="btn btn-jh-edit btn-primary" form="editJHPromotionForm">确认</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">新增促销品销售政策</h4>

				</div>
				<div class="modal-body">
					<form class="form-horizontal" action="salePolicy/editPolicyLine" id="addCXPromotionForm">
						<div class="form-group  ">
							<label for="materialId" class=" col-sm-3 control-label">订单SKU：</label>
							<div class=" col-sm-5">
								<!-- <select class="form-control" data-placeholder="请选择SKU..."
								...
								<select class="form-control" data-placeholder="请选择SKU..."	 name="materialId"	id="cxmaterialId">
								</select>
							</div>
							<input type="hidden" name="headerId" value="${policy.id}">
							<small class="help-block col-sm-4"></small>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="submit" class="btn btn-cx-save btn-primary" form="addCXPromotionForm">确认添加</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
	...
	<%-- modal 修改促销品销售政策 --%>
	<div class="modal fade" id="editcxPolicyModal" tabindex="-1" role="dialog">
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
					...
					<h4 class="modal-title">修改促销品销售政策</h4>

				</div>
				<div class="modal-body">
					<form class="form-horizontal" action="salePolicy/editPolicyLine" id="editCXPromotionForm">
						<div class="form-group  ">
							<label for="materialId" class=" col-sm-3 control-label">订单SKU：</label>
							<div class=" col-sm-5">
								<!-- <select class="form-control" data-placeholder="请选择SKU..."
								...
								<select class="form-control" data-placeholder="请选择SKU..."	 name="materialId"	id="editcxmaterialId">
								</select>
							</div>
							<input type="hidden" name="headerId" value="${policy.id}">
							<input type="hidden" name="id" id="editcxid">
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="discount" class="col-sm-3 control-label">单位:</label>
							<div class=" col-sm-5">
								<input type="text" class="form-control" 
									id="editcxunit" readonly="readonly">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							...
							<div class=" col-sm-5">
								<input type="text" class="form-control" 
									id="editcxprice" readonly="readonly">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="discount" class="col-sm-3 control-label">促销品：</label>
							<div class=" col-sm-5">
								<select class="form-control" name="discount" id="editcxdiscount">
								</select>
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="primary" class="col-sm-3 control-label ">目标数量：</label>
							<div class="col-sm-5">
								<input type="text" class="  form-control" id="editcxprimary"
									name="primary" placeholder="目标数量">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="discountIntensity" class="col-sm-3  control-label">赠送数量：</label>
							<div class=" col-sm-5">
								<input type="text" class="form-control" id="editcxdiscountIntensity"
									name="discountIntensity" placeholder="赠送数量">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
						<div class="form-group  ">
							<label for="limit" class="col-sm-3 control-label ">赠送限量：</label>
							<div class=" col-sm-5">
								<input type="text" class="form-control" id="editcxlimit"
									name="limit" placeholder="赠送限量">
							</div>
							<small class="help-block col-sm-4"></small>
						</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="submit" class="btn btn-cx-edit btn-primary" form="editCXPromotionForm">确认</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
	...
	<div class="form-horizontal row" style="margin: 0 0 20px 0;">
		<div class="form-group col-md-12 input-box-list">
			<label for="input1" class=" font12 input-box-list-title">执行范围：</label>
			<div class="input-box-list-value">
		...
		<div class="form-group col-md-12 input-box-list" id="custs" style="display: none">
			<label for="input1" class=" font12 input-box-list-title">执行客户：</label>
			<div class="input-box-list-value">
				<div class="input-group">
					<input type="text" class="form-control tokenfield" id="agentCust"
						name="agentCust" disabled="disabled"/>
					<!-- <div class="input-group-addon" style="cursor: pointer;"
						 id="addPolicyCust">
						<i class="icon icon-plus"></i>
					</div> -->
	...
	<%-- block 3 --%>
	<input type="hidden" id="verification" value="${policyType.verification }">
	<div id="policysku" ${policyType.type =="1"?"style='display:block;'":"style='display:none;'"} >
	...
	<script type="text/javascript" src="static/js/salepolicy/policyEdit.js"></script>
</body>
</html>
