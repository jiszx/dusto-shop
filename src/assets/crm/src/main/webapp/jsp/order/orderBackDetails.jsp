...
<form>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6 col-sm-12 factory-select-box">
            <p class="text-muted order-item" style="width:120px !important; text-align:left;">原销售订单编号:</p>
            <div class="form-group" style="width:100%;">
        ...
        <c:if test="${order.attribute2 !=null }">     
        <input type="hidden" id="saltOrderId" value="${order.attribute2 }">   
        	<div class="form-group col-md-6 col-sm-12 factory-select-box">
            <p class="text-muted order-item" style="width:120px !important; text-align:left;">对应合作盐业公司退货订单:</p>
            <div class="form-group" style="width:100%;">
	            <input type="text" class="form-control" value="${order.attribute2 }" disabled style="border-radius:5px !important;width:60% !important;">
            </div>
        	</div>
        	<div class="form-group col-md-6 col-sm-12 factory-select-box">
            <p class="text-muted order-item" style="width:120px !important; text-align:left;">合作盐业公司名称:</p>
            <div class="form-group" style="width:100%;">
	            <input type="text" class="form-control" value="${saltCustNamt }" disabled style="border-radius:5px !important;width:60% !important;">
            </div>
        	</div>
        </c:if>
    </div>
...
<script type="text/javascript" src="static/js/order/orderBackDetails.js"></script>
