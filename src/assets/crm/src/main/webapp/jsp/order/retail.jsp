...
<div >
    ...
    <div class="col-md-12 col-sm-12" id="ordersearchTool" style="padding:0;">
        <div class="btn-group btn-group-sm" role="group" aria-label="...">
            ...
            <button type="button" id="importBtn" class="btn btn-fail">
                <i class='icon icon-edit' style="height:14px;"></i> 批量导入
            </button>
...
<script type="text/javascript" src="static/js/order/retail.js"></script>
</body>
</html>
