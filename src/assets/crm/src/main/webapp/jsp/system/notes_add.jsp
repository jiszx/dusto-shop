...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#">系统管理</a></li>
        <li><a href="system/notes/index.html" target="_self">公告管理</a></li>
        <li class="active">添加公告</li>
    </ol>
</section>
<div class="col-md-12">
    <form action="system/notes/add" method="post" enctype="multipart/form-data"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <textarea class="form-control" name="descTxt" placeholder="概要信息,不超过100个字"></textarea>
            </div>
            <small class="help-block col-sm-4"></small>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" id="areaTree" class="form-control" name="area">
            </div>
        </div>
        <div class="form-group">
...
<script src="static/js/system/addNote.js" type="text/javascript"></script>
</body>
</html>
