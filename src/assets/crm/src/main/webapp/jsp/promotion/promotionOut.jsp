...
<body class="container-fluid content">
	...
	<div class="col-md-12 col-sm-12" style="padding: 0;">
		...
		<div class="form-group col-md-3 col-sm-6">
			<label>所属销售组织:</label> <select class="form-control customizeWidth"
				id="searchorgid">
				<option></option>
		...
		<div class="form-group col-md-3 col-sm-6">
			<label>库房名称:</label> <select class="form-control customizeWidth"
				id="searchstoresid">
			</select>
		</div>
		<div class="form-group col-md-3 col-sm-6">
			<label>采购方名称:</label> <select class="form-control customizeWidth"
				id="searchpurid">
			</select>
		</div>
		<div class="form-group col-md-3 col-sm-6" style="margin-left: 29px;">
			<label>状态:</label> <select class="form-control customizeWidth"
				id="searchstates">
				<option></option>
				<c:forEach items="${dict['T_PROMOTION_STATES']}" var="it">
					<option value="${it.chooseVal}">${it.showText}</option>
				</c:forEach>
			</select>
		</div>
		<div class="form-group col-md-3 col-sm-6" style="float:right; margin-left:-29px;">
	...
	<div class="col-md-12" id="promotionApplyTool" style="padding: 0;">
		<div class="btn-group btn-group-sm" role="group" aria-label="...">
			<button type="button" class="btn  btn-info" data-toggle="modal"
				...
				<i class='icon icon-expand'></i> 出库申请
			</button>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">促销品出库申请</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" method="post"
						...
						<div class="form-group">
							<label for="storesId" class="col-sm-3 control-label">库房</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label for="invnum" class="col-sm-3 control-label">当前库存数量</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label for="amt" class="col-sm-3 control-label">出库金额</label>
							<div class="col-sm-5">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="dictLabel">促销品出库申请修改</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" method="post"
						...
						<div class="form-group">
							<label for="promotionId" class="col-sm-3 control-label">促销品名称</label>
							<div class="col-sm-5">
								<select class="form-control" id="editpromotionId"
									name="promotionId">
								</select>
							</div>
							<small class="help-block col-sm-4"></small>
						...
						<div class="form-group" id="ed" style="display: none">
							<label for="invnum" class="col-sm-3 control-label">当前库存数量</label>
							<div class="col-sm-5">
	...
	<script type="text/javascript"
		src="static/js/promotion/promotionOut.js"></script>
</body>
</html>
