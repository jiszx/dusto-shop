...
<body class="container-fluid content">
	...
	<div class="col-md-12" id="promotionStoresTool" style="padding: 0;">
		<div class="btn-group btn-group-sm" role="group" aria-label="...">
			<button type="button" class="btn btn-primary" data-toggle="modal"
				data-target="#addpromotionStoresModal">
	...
	<div class="col-md-12">
		<table id="promotionStoresTable"></table>
	</div>
	<!-- addDialog-->
	<div class="modal fade" id="addpromotionStoresModal" tabindex="-1"
		role="promotionStoresTool" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="dictLabel">新增仓库</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" method="post"
						action="promotion/stores/add" id="addPromotionStoresForm">
				...
				<div class="modal-footer">
					...
					<button type="submit" id="btn-add" class="btn btn-primary btn-save"
						form="addPromotionStoresForm">保存</button>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- editDialog-->
	<div class="modal fade" id="editpromotionStoresModal" tabindex="-1"
		role="promotionStoresTool" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="dictLabel">修改库房信息</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal" method="post"
						action="promotion/stores/edit" id="editPromotionStoresForm">
						<div class="form-group">
							<label for="organizationId" class="col-sm-3 control-label">所属销售组织</label>
				...
				<div class="modal-footer">
					...
					<button type="submit" id="btn-edit-save"
						class="btn btn-primary btn-save" form="editPromotionStoresForm">保存</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript"
		src="static/js/promotion/promotionStores.js"></script>
</body>
</html>
