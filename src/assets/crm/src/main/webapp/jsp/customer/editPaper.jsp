...
<body class="container-fluid content">
	...
	<div class="col-md-12" style="min-height: 200px; padding: 10px 0;">
				...
				<div class="form-group col-md-4 col-sm-6 input-box-list">
					...
					<div class="input-box-list-value">
						<input type="text" class="form-control" id="agentArea"
							placeholder="输入经销区域..." value="${vo.agentArea}"
							readonly="readonly">
					</div>
				</div>
				<div class="form-group col-md-4 col-sm-6 input-box-list">
					...
					<div class="input-box-list-value">
						<input type="text" class="form-control" id="deliveryAddress"
							name="deliveryAddress" value="${vo.deliveryAddress}"
							placeholder="交货地点" readonly="readonly">
					</div>
				</div>
				<div class="form-group col-md-4 col-sm-6 input-box-list">
				...
				<div class="form-group col-md-4 col-sm-6 input-box-list">
					...
					<div class="input-box-list-value">
						<input type="text" class="form-control" id="creditAmt"
							name="creditAmt" value="${vo.creditAmt}" placeholder="授信额度">
					</div>
				</div>
				<div class="form-group col-md-4 col-sm-6 input-box-list">
		...
		<div class="page-header hide" id="block-2" style="margin-bottom: 0;">
			<h4 class="text-info">
		...
		<div class="row " style="margin: 0 0 20px 0;">
			<div class="col-md-12">
				<form class="form-horizontal row add-bstb-box hide" id="addAgentForm"
					...
					<input type="hidden" name="agentType" id="agent_type" value="${vo.agentType}">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal"
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="hidden" id="editid" name="id"> <input
									type="text" class="form-control" id="editagentType" readonly>
							</div>
						...
						<div class="form-group">
							<label for="edityAmt" class="col-sm-3 control-label">年度进货目标</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="edityRatio" class="col-sm-3 control-label">年度进货比例</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="editqAmt" class="col-sm-3 control-label">季度进货目标</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="editqAmt"
									name="qAmt">
							</div>
							<small class="help-block col-sm-3"></small>
						</div>
						...
						<div class="form-group">
							<label for="editqRatio" class="col-sm-3 control-label">季度进货比例</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="editqRatio"
									name="qRatio">
							</div>
							<small class="help-block col-sm-3"></small>
						</div>
	...
	<script type="text/javascript" src="static/js/customer/editPaper.js"></script>
