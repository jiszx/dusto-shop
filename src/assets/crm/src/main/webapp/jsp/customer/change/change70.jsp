    ...
    <div id="changeDiv" class="form-group col-md-6" style="border-right:solid 1px #999;margin-right:15px;margin-left:15px;">
	    ...
	    <div class="form-horizontal row" style="margin: 0 0 20px 0;">
	        ...
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            ...
	            <div class="input-box-list-value">
	                <input type="text" name="businessLicense" value="${changeVo.businessLicense }" class="required form-control" id="input_businessLicense" >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
			...
			<input type="hidden" value="70" name="custType">
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	        ...
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input_pid" class=" font12 input-box-list-title label-base">合作盐业公司：</label>
	            <input type="hidden" value="${changeVo.pid }" id="customerHiddenInput">
	            <div class="input-box-list-value">
	                <select class="required form-control" disabled name="pid" data-placeholder="请选择合作盐业公司信息..." id="customerSelection">
					</select>
	            </div>
	        </div>
