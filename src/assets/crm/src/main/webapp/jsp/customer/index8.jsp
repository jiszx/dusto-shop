    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="confirmDistributionBtn">确认添加</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<form id="saveForm" class="col-md-12" enctype="multipart/form-data" style=" min-height: 200px; padding:10px 0;" action="customer/save.html" method="post">
    ...
    <div class="form-horizontal row" style="margin: 0 0 20px 0;">
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="businessLicense" value="${custBase.businessLicense }" class="required form-control" id="input_businessLicense" placeholder="营业执照号">
            </div>
        </div>
        <div class="form-group col-md-4 col-sm-6 input-box-list">
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-base">邮箱：</label>
            <div class="input-box-list-value">
                <input type="text" name="email" value="${custBase.email }" class="form-control" id="input_tel" placeholder="邮箱">
            </div>
        </div>
    </div>
    <%-- block 3 --%>
