...
<form id="saveForm" class="col-md-12" enctype="multipart/form-data" style=" min-height: 200px; padding:10px 0;" action="customer/save.html" method="post">
    ...
    <div class="form-horizontal row" style="margin: 0 0 20px 0;">
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="sapCustomerId" value="${custBase.sapCustomerId }" class="form-control" id="input1" placeholder="客户编号" readonly>
            </div>
        </div>
        <div class="form-group col-md-4 col-sm-6 input-box-list">
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="tel" value="${custBase.tel }" class="form-control" id="input1" placeholder="财务电话">
            </div>
        </div>
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            ...
            <div class="input-box-list-value">
                <select name="channelId" class="form-control no-appearance" value="${custBase.channelId }" id="input-agent-type">
...
<script type="text/javascript" src="static/js/customer/editRetail.js"></script>
