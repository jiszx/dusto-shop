...
$(function(){
    ...
    $("#addPaperForm").ajaxForm({
        ...
        beforeSubmit:  function(formData, jqForm, options){
            ...
            if($("#agentArea").val().length <=0){
            	$("#agentArea").parent().addClass("borderColor");
            	falg = false;
            }
            if($("#deliveryAddress").val().length <=0){
            	$("#deliveryAddress").parent().addClass("borderColor");
                falg = false;
            }
            ...
            if($("#creditAmt").val()>100000000){
            	$.messager.alert("添加合同信息失败","授信额度不得超过1亿!");
                falg = false;
            }
            if($("#settleType").val()=="2" && $("#aPeriod").val()==""){
            	$("#aPeriod").parent().addClass("borderColor");
            	falg=false;
            }
