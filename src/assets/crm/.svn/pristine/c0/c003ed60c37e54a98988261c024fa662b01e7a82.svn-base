...
<form id="saveForm" class="col-md-12" enctype="multipart/form-data" style=" min-height: 200px; padding:10px 0;" action="customer/save.html" method="post">
    ...
    <div id="changeDiv" class="form-group col-md-6" style="border-right:solid 1px #999;margin-right:15px;margin-left:15px;">
	    ...
	    <div class="form-horizontal row" style="margin: 0 0 20px 0;">
	        ...
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            ...
	            <div class="input-box-list-value">
	                <input type="text" name="lpName" value="${changeVo.lpName }"  class="form-control" id="input_lpName" >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input_lpNo" class=" font12 input-box-list-title label-base">法人身份证号：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="lpNo" value="${changeVo.lpNo }" class="form-control" id="input_lpNo" >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input_contactName" class=" font12 input-box-list-title label-base">客户联系人：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="contactName" value="${changeVo.contactName }" class="form-control" id="input_contactName" >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input_contactTel" class=" font12 input-box-list-title label-base">业务电话：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="contactTel" value="${changeVo.contactTel }" class="form-control" id="input_contactTel" >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input_businessLicense" class=" font12 input-box-list-title label-base">营业执照号：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="businessLicense" value="${changeVo.businessLicense }" class="form-control" id="input_businessLicense" >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	        ...
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            ...
	            <div class="input-box-list-value">
	                <select class="form-control no-appearance" name="payer" id="input_payer">
	        ...
	        <%-- <div class="form-group col-md-6 col-sm-6 input-box-list">
	            ...
	            <div class="input-box-list-value">
	                <div class="input-group">
			            <input type="text" name="minOrder" value="${(empty changeVo || empty changeVo.minOrder)?10:changeVo.minOrder }" id="input_minOrder" class="form-control" >
	    ...
	    <div class="row form-horizontal" style="margin: 0 0 20px 0;">
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            ...
	            <div class="input-box-list-value">
	                <input type="text" name="invoiceName" value="${changeVo.invoiceName }" class="form-control"  >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input1" class=" font12 input-box-list-title">税号：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="invoiceTaxNum" value="${changeVo.invoiceTaxNum }" class="form-control"  >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input1" class=" font12 input-box-list-title">地址：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="invoiceAddress" value="${changeVo.invoiceAddress }" class="form-control"  >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input1" class=" font12 input-box-list-title">账户：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="invoiceAccount" value="${changeVo.invoiceAccount }" class="form-control"  >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input1" class=" font12 input-box-list-title">电话：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="invoiceTel" value="${changeVo.invoiceTel }" class="form-control"  >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input1" class=" font12 input-box-list-title">常用打款银行名称：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="invoiceBankName" value="${changeVo.invoiceBankName }" class="form-control"  >
	            </div>
	        </div>
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input1" class=" font12 input-box-list-title">常用打款账户名称：</label>
	            <div class="input-box-list-value">
	                <input type="text" name="invoiceAccountName" value="${changeVo.invoiceAccountName }" class="form-control"  >
	            </div>
	        </div>
	    </div>
	    <%-- block 5 --%>
	    ...
	    <div class="row" style="margin: 0 0 20px 0;">
	        ...
	        <div class="col-md-4 col-sm-6">
	            <div class="contact-box-add" id="file-item-add-box" title="上传附件">
	                ...
	                <input type="hidden" name="delAtts" >
	            </div>
	        </div>
	    </div> --%>
    </div>
    <div class="form-group form-group col-md-6" id="oldDiv">
	    ...
	    <div class="form-horizontal row" style="margin: 0 0 20px 0;">
	        ...
	        <div class="form-group col-md-6 col-sm-6 input-box-list">
	            <label for="input1" class=" font12 input-box-list-title label-base">付款方：</label>
	            <div class="input-box-list-value">
	                <select disabled class="form-control no-appearance" id="existedPayer">
    ...
    <input type="hidden" name="id" id="id" value="${custBase.id }">
    <input type="hidden" name="tempPid" id="tempPid" value="${custBase.pid }">
    <input type="hidden" name="tempPayer" id="tempPayer" value="${custBase.payer }">
