...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#"> 协同办公</a></li>
        <li class="active">已完成的申请</li>
    </ol>
</section>
<div class="panel scroll panel-info " style="min-height: 500px;">
    <div class="col-md-12" id="dictTool">
        <div class="btn-group btn-group-sm" role="group" aria-label="...">
            <button type="button" class="btn btn-show btn-success"><i class='icon icon-eye-open'></i> 查看流程审批</button>
        </div>
    </div>
    <div class="col-md-12">
...
<script type="text/javascript" src="static/js/process/history.js"></script>
</body>
</html>
