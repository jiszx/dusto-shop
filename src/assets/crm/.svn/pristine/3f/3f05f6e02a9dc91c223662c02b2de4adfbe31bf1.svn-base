...
<head>
    <base href="<%=basePath%>">
    <title>配置与监控-错误信息配置</title>
    <jsp:include page="/common/head.jsp"></jsp:include>
    <link href="static/table/bootstrap-table.min.css" rel="stylesheet">
</head>
<body class="container-fluid content">
<section class="content-header">
 <h1>配置与监控<small>错误信息配置</small>
 </h1>
 <ol class="breadcrumb">
     <li><a href="#"><i class="icon icon-home"></i> 首页</a></li>
     <li><a href="#">配置与监控</a></li>
     <li class="active">错误信息配置</li>
 </ol>
</section>
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="system/dict/edit" method="post" id="editDictForm">
                    ...
                    <div class="form-group">
                        <label for="chooseVal" class="col-sm-2 control-label">异常类</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label for="editcolDescription" class="col-sm-2 control-label">异常说明</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label for="showText" class="col-sm-2 control-label">异常信息</label>
                        <div class="col-sm-6">
...
<script type="text/javascript">
    function getDictValue(state){
        var data = new Object();
        <c:forEach items="${dict['EXCEPTION_LEVEL']}" var="states">
...
<script type="text/javascript" src="static/js/monitor/exception.js"></script>
</body>
</html>
