...
<div class="col-md-12" id="querycondition" style="padding-left:0px;">
    ...
    <form class=" form-inline"  onsubmit="doSearch()">
        ...
        <div class="form-group col-md-3 col-sm-6">
            <label>调拨单单号:</label>
            <input type="text" class="form-control" id="transferOrderid">
        </div>
        <div class="form-group col-md-3 col-sm-6">
            <label>开始时间　:</label>
...
<div class="col-md-12 col-sm-12" id="ordersearchTool" style="padding:0;">
    <div class="btn-group btn-group-sm" role="group" aria-label="...">
        ...
        <!-- <button type="button" id="btn-saveagain" class="btn btn-del btn-primary">
            <i class='icon icon-plus'></i> 再次购买
        </button> -->
        <button type="button" id="markBtn" class="btn btn-edit">
            <i class='icon icon-share'></i>标记待打印发票
        </button>
        <button type="button" id="exportBtn" class="btn btn-warning">
            <i class='icon icon-share'></i>导出详情
        </button>
        <button type="button" id="exportBtn2" class="btn btn-primary">
...
<script type="text/javascript" src="static/js/order/orderIndex.js"></script>
</body>
</html>
