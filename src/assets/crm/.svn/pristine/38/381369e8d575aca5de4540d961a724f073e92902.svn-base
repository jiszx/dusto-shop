...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="#">客户档案</li>
        <li class="active">客户变更档案</li>
    </ol>
</section>
<form id="saveForm" class="col-md-12" enctype="multipart/form-data" style=" min-height: 200px; padding:10px 0;" action="" method="post">
    <%-- block 1 --%>
    ...
    <div class="form-horizontal">
        <div class="form-group">
            <label for="input_name" class="col-md-2 font12 input-box-list-title label-base">变更编号：</label>
            <div class="input-box-list-value col-md-4">
                <input type="text" name="name" class="form-control" readonly="readonly" value="${changeId }">
            </div>
            <label for="input_name" class="col-md-2 font12 input-box-list-title label-base">变更主题：</label>
            <div class="input-box-list-value col-md-4">
                <input type="text" name="name" class="form-control" id="input_name" placeholder="">
            </div>
        </div>

        <div class="form-group">
            <label for="input_name" class="col-md-2 font12 input-box-list-title label-base">客户名称：</label>
            <div class="input-box-list-value col-md-4">
                <input type="text" name="name" class="form-control" value="${custBase.name }">
            </div>
            <label for="input_name" class=" col-md-2 font12 input-box-list-title label-base">原客户名称：</label>
            <div class="input-box-list-value col-md-4">
                <input type="text" name="name" class="form-control" readonly="readonly" value="${custBase.name }">
            </div>
        </div>

        <div class="form-group">
            <label for="input_name" class="col-md-2 font12 input-box-list-title label-base">客户简称：</label>
            <div class="input-box-list-value col-md-4">
                <input type="text" name="name" class="form-control" value="${custBase.name }">
            </div>
            <label for="input_name" class=" col-md-2 font12 input-box-list-title label-base">原客户简称：</label>
            <div class="input-box-list-value col-md-4">
                <input type="text" name="name" class="form-control" readonly="readonly" value="${custBase.name }">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="input_name" class="col-md-2 font12 input-box-list-title label-base">所属地区：</label>
            <div class="input-box-list-value col-md-4">
                <div class="input-box-list-value">
                    <input type="hidden" name="provName">
                    <input type="hidden" name="cityName">
                    <input type="hidden" name="countyName">
                    <input type="text" value="${custBase.provId }" id="provIdEle">
                    <input type="text" value="${custBase.cityId }" id="cityIdEle">
                    <input type="text" value="${custBase.countyId }" id="countyIdEle">

                </div>
            </div>
            <label for="input_name" class=" col-md-2 font12 input-box-list-title label-base">原所属地区：</label>
            <div class="input-box-list-value col-md-4">
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            <label for="input_lpName" class=" font12 input-box-list-title label-base">原法人名称：</label>
            <div class="input-box-list-value">
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="contactName" value="${custBase.contactName }" class="form-control" id="input_contactName" placeholder="客户业务联系人">
            </div>
        </div>
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            <label for="input_contactTel" class=" font12 input-box-list-title label-base">业务联系电话：</label>
            <div class="input-box-list-value">
                <input type="text" name="contactTel" value="${custBase.contactTel }" class="form-control" id="input_contactTel" placeholder="业务联系电话">
            </div>
        </div>
        <div class="form-group col-md-4 col-sm-6 input-box-list">
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="tel" value="${custBase.tel }" class="form-control" id="input_tel" placeholder="公司电话">
            </div>
        </div>
        <%-- <div class="form-group col-md-4 col-sm-6 input-box-list">
		...
		<input type="hidden" value="7" name="custType">
        <div class="form-group col-md-8 col-sm-12 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="address" value="${custBase.address }" class="form-control" id="required input_address" placeholder="公司地址">
            </div>
        </div>
        <div class="form-group col-md-4 col-sm-6 input-box-list">
    ...
    <div class="row form-horizontal" style="margin: 0 0 20px 0;">
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="invoiceTaxNum" value="${custBase.invoiceTaxNum }" class="required form-control" id="input_invoiceTaxNum" placeholder="税号">
            </div>
        </div>
        <div class="form-group col-md-4 col-sm-6 input-box-list">
