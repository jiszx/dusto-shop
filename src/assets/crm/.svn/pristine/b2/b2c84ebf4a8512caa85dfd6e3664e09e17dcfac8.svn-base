...
<body class="container-fluid content">
	<section class="content-header">
	 ...
	 <div class="row">
    	<input type="hidden" id="merchCustId" value="${account.merchCustId}">
        <div class="col-md-4 col-sm-6 input-box-list">
            <p class="text-muted order-item">客户名称:</p>
            <div class="form-group" style="width:100%;">
	            <input type="text" class="form-control" value="${account.custname }" disabled style="border-radius:5px !important;width:60% !important;">
            </div>
        </div>
        <div class="col-md-4 col-sm-6 factory-select-box">
            <p class="text-muted order-item">销售组织:</p>
            <div class="form-group" style="width:100%;">
	            <input type="text" class="form-control" value="${account.orgname}" disabled style="border-radius:5px !important;width:60% !important;">
            </div>
        </div>
        <div class="col-md-4 col-sm-6 factory-select-box">
            <p class="text-muted order-item">SAP编码:</p>
            <div class="form-group" style="width:100%;">
	            <input type="text" class="form-control" value="${account.sapCustomerId}" disabled style="border-radius:5px !important;width:60% !important;">
            </div>
        </div>
        <div class="col-md-4 col-sm-6 factory-select-box">
            <p class="text-muted order-item">现金合计:</p>
            <div class="form-group" style="width:100%;">
	            <input type="text" class="form-control" value="${account.cashAmt}" disabled style="border-radius:5px !important;width:60% !important;">
            </div>
        </div>
        <div class="col-md-4  col-sm-6 factory-select-box">
            <p class="text-muted order-item">授信合计:</p>
            <div class="form-group" style="width:100%;">
	            <input type="text" class="form-control" value="${account.creditAmt}" disabled style="border-radius:5px !important;width:60% !important;">
            </div>
        </div>
        <div class="col-md-4 col-sm-6 factory-select-box">
            <p class="text-muted order-item">货补合计:</p>
            <div class="form-group" style="width:100%;">
	            <input type="text" class="form-control" value="${account.subsidyAmt}" disabled style="border-radius:5px !important;width:60% !important;">
            </div>
        </div>
    </div>
	...
	<script type="text/javascript" src="static/js/account/accountDetails.js"></script>
</body>
</html>
