<!-- deprecated and edit function could be finished in index.jsp -->
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">新增送货方</h4>

            </div>
            <div class="modal-body">
                <div class="form-horizontal row" style="padding-right: 20px;">
                    <div class="form-group col-md-12 input-box-list">
                        <label for="input1" class=" font12 input-box-list-title">送达方名称：</label>
                        <div class="input-box-list-value">
                            <input type="text" class="form-control" id="form_distribute_input_name" placeholder="送达方名称">
                        </div>
                    </div>
                    <div class="form-group col-md-12 input-box-list">
                        <label for="input1" class=" font12 input-box-list-title">物流公司：</label>
                        <div class="input-box-list-value">
                            <input type="text" class="form-control" id="form_distribute_input_logistics" placeholder="物流公司">
                        </div>
                    </div>
                    <div class="form-group col-md-12 input-box-list">
                        <label for="input1" class=" font12 input-box-list-title">到站地址：</label>
                        <div class="input-box-list-value">
                            <input type="text" class="form-control" id="form_distribute_input_site" placeholder="到站地址">
                        </div>
                    </div>
                    <div class="form-group col-md-12 input-box-list">
                        <label for="input1" class=" font12 input-box-list-title">收货人姓名：</label>
                        <div class="input-box-list-value">
                            <input type="text" class="form-control" id="form_distribute_input_contacter" placeholder="收货人姓名">
                        </div>
                    </div>
                    <div class="form-group col-md-12 input-box-list">
                        <label for="input1" class=" font12 input-box-list-title">收货人联系电话：</label>
                        <div class="input-box-list-value">
                            <input type="text" class="form-control" id="form_distribute_input_mobile" placeholder="收货人联系电话">
                        </div>
                    </div>
                    <div class="form-group col-md-12 input-box-list">
                        <label for="input1" class=" font12 input-box-list-title">收货地址：</label>
                        <div class="input-box-list-value">
                            <input type="text" class="form-control" id="form_distribute_input_address" placeholder="收货地址">
                        </div>
                    </div>
                </div>
            </div>
...
<form id="saveForm" class="col-md-12" enctype="multipart/form-data" style=" min-height: 200px; padding:10px 0;" action="customer/save.html" method="post">
    ...
    <div class="form-horizontal row" style="margin: 0 0 20px 0;">
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-base">经销商名称：</label>
            <div class="input-box-list-value">
                <input type="text" name="name" class="form-control" id="input1" value="${custBase.name }" placeholder="客户名称">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-base">经销商简称：</label>
            <div class="input-box-list-value">
        ...
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-base">法人名称：</label>
            <div class="input-box-list-value">
                <input type="text" name="lpName" value="${custBase.lpName }"  class="form-control" id="input1" placeholder="法人名称">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-base">法人身份证号：</label>
            <div class="input-box-list-value">
                <input type="text" name="lpNo" value="${custBase.lpNo }" class="form-control" id="input1" placeholder="法人身份证号">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-base">业务联系人：</label>
            <div class="input-box-list-value">
                <input type="text" name="contactName" value="${custBase.contactName }" class="form-control" id="input1" placeholder="业务联系人">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-base">业务电话：</label>
            <div class="input-box-list-value">
                <input type="text" name="contactTel" value="${custBase.contactTel }" class="form-control" id="input1" placeholder="业务电话">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-base">营业执照号：</label>
            <div class="input-box-list-value">
                <input type="text" name="businessLicense" value="${custBase.businessLicense }" class="form-control" id="input1" placeholder="营业执照号">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-base">客户电话：</label>
            <div class="input-box-list-value">
                <input type="text" name="tel" value="${custBase.tel }" class="form-control" id="input1" placeholder="客户电话">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
    ...
    <div class="page-header" id="block-3">
        <h4 class="text-info"><strong>2.&nbsp;</strong>送达方信息&nbsp;-&nbsp;
            ...
            <a href="javascript:;" class=" text-info block-save-link" data-toggle="modal"
               data-target="#addRecevingModal"><i class="icon icon-plus"></i>&nbsp;&nbsp;新增</a>
        </h4>
    </div>
    <div class="row" style="margin: 0 0 20px 0;">
    	<c:forEach items="${custBase.distributions }" var="distribution" varStatus="status">
	    	<div class="col-md-4" id="distribution_${status.index+1}">
	            ...
	            <div class="bank-box">
	                ...
	                <div class="row font12" style="line-height: 24px;">
	                    <div class="col-md-4 text-right">送达方名称：</div>
	                    <div class="col-md-8" style="padding-left: 0;"><input name="name" value="${distribution.name}" type="hidden"><span>${distribution.name}</span></div>
	                </div>
	                <div class="row font12" style="line-height: 24px;">
	                    <div class="col-md-4 text-right">物流：</div>
	                    <div class="col-md-8" style="padding-left: 0;"><input name="logistics" value="${distribution.logistics}" type="hidden"><span>${distribution.logistics}</span></div>
	                </div>
	                <div class="row font12" style="line-height: 24px;">
	                    <div class="col-md-4 text-right">到站：</div>
	                    <div class="col-md-8" style="padding-left: 0;"><input name="site" value="${distribution.site}" type="hidden"><span>${distribution.site}</span></div>
	                </div>
	                <div class="row font12" style="line-height: 24px;">
	                    <div class="col-md-4 text-right">联系人：</div>
	                    <div class="col-md-8" style="padding-left: 0;"><input name="contacter" value="${distribution.contacter}" type="hidden"><span>${distribution.contacter}</span></div>
	                </div>
	                <div class="row font12" style="line-height: 24px;">
	                    <div class="col-md-4 text-right">联系人电话：</div>
	                    <div class="col-md-8" style="padding-left: 0;"><input name="mobile" value="${distribution.mobile}" type="hidden"><span>${distribution.mobile}</span></div>
	                </div>
	                <div class="row font12" style="line-height: 24px;">
	                    <div class="col-md-4 text-right">收货地址：</div>
	                    <div class="col-md-8" style="padding-left: 0;"><input name="address" value="${distribution.address}" type="hidden"><span>${distribution.address}</span></div>
	                </div>
	            </div>
	        </div>
    	</c:forEach>
        
        <div class="col-md-4" style="display:none;"  id="distribution_${custBase.distributions.size()+1 }">
            <div class="bank-box">
                <div class="page-header" style="padding: 5px 0; margin-bottom: 10px;">
                    <h4 class="">
                ...
                <div class="row font12" style="line-height: 24px;">
                    <div class="col-md-4 text-right">送达方名称：</div>
                    <div class="col-md-8" style="padding-left: 0;"><input name="name" type="hidden"></div>
                </div>
                <div class="row font12" style="line-height: 24px;">
                    <div class="col-md-4 text-right">物流：</div>
                    <div class="col-md-8" style="padding-left: 0;"><input name="logistics" type="hidden"></div>
                </div>
                <div class="row font12" style="line-height: 24px;">
                    <div class="col-md-4 text-right">到站：</div>
                    <div class="col-md-8" style="padding-left: 0;"><input name="site" type="hidden"></div>
                </div>
                <div class="row font12" style="line-height: 24px;">
                    <div class="col-md-4 text-right">联系人：</div>
                    <div class="col-md-8" style="padding-left: 0;"><input name="contacter" type="hidden"></div>
                </div>
                <div class="row font12" style="line-height: 24px;">
                    <div class="col-md-4 text-right">联系人电话：</div>
                    <div class="col-md-8" style="padding-left: 0;"><input name="mobile" type="hidden"></div>
                </div>
                <div class="row font12" style="line-height: 24px;">
                    <div class="col-md-4 text-right">收货地址：</div>
                    <div class="col-md-8" style="padding-left: 0;"><input name="address" type="hidden"></div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="bank-box-add" data-toggle="modal" data-target="#addRecevingModal">
                <i class="icon icon-plus"></i>&nbsp;&nbsp;添加物流信息
    ...
    <div class="row form-horizontal" style="margin: 0 0 20px 0;">
        ...
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="invoiceAccount" value="${custBase.invoiceAccount }" class="form-control" id="input1" placeholder="税号">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
        ...
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="invoiceAccountName" value="${custBase.invoiceAccountName }" class="form-control" id="input1" placeholder="常用打款账户名称">
            </div>
        </div>
    </div>
    block 3
    ...
    block 3
    <div class="page-header" id="block-3">
        <h4 class="text-info"><strong>4.&nbsp;</strong>我司产品拓展计划&nbsp;-&nbsp;
            <small>Receiving Information.</small>
            <a href="javascript:;" class=" text-info block-save-link"><i class="icon icon-save"></i>&nbsp;&nbsp;保存</a>
        </h4>
    </div>
    <div class="row form-horizontal" style="margin: 0 0 20px 0;">
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="planArea" value="${custBase.planArea }" class="form-control" id="input1"
        ...
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="planBrand" value="${custBase.planBrand }" class="form-control" id="input1"
        ...
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="planCategory" value="${custBase.planCategory }" class="form-control" id="input1" placeholder="泡菜/全料/豆瓣/甜面酱">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-section">KA渠道：</label>
            <div class="input-box-list-value">
                <input type="text" name="expandKaPlace" value="${custBase.expandKaPlace }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-section">BC渠道：</label>
            <div class="input-box-list-value">
                <input type="text" name="expandBcPlace" value="${custBase.expandBcPlace }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-section">流通（农贸/批发）渠道：</label>
            <div class="input-box-list-value">
                <input type="text" name="expandCirculatePlace" value="${custBase.expandCirculatePlace }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-section">工厂：</label>
            <div class="input-box-list-value">
                <input type="text" name="expandFactoryPlace" value="${custBase.expandFactoryPlace }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-section">学校渠道：</label>
            <div class="input-box-list-value">
                <input type="text" name="expandSchoolPlace" value="${custBase.expandSchoolPlace }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        ...
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="expandRetailPlace" value="${custBase.expandRetailPlace }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        <div class="form-group col-md-4 input-box-list">
            <label for="input1" class=" font12 input-box-list-title label-section">该区域人口数：</label>
            <div class="input-box-list-value">
                <input type="text" name="expandAreaPeoples" value="${custBase.expandAreaPeoples }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        ...
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="expandAreaVolume" value="${custBase.expandAreaVolume }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        ...
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="expandBusinesVolume" value="${custBase.expandBusinesVolume }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        ...
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="expandSpentMamt" value="${custBase.expandSpentMamt }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
        ...
        <div class="form-group col-md-4 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="expandSpentFamt" value="${custBase.expandSpentFamt }" class="form-control" id="input1" placeholder="">
            </div>
        </div>
    ...
    block 3
    <div class="page-header" id="block-3">
        <h4 class="text-info"><strong>4.&nbsp;</strong>企业背景&nbsp;-&nbsp;
            <small>Receiving Information.</small>
            <a href="javascript:;" class=" text-info block-save-link"><i class="icon icon-save"></i>&nbsp;&nbsp;保存</a>
        </h4>
    </div>
            ...
            <div class="contact-box">
                <ul class="file-list">
                	<c:forEach items="${custBase.attachments }" var="attachment" varStatus="attStatus">
                		<li>
	                        <span class="file-name" data-file-src="">${attachment.attachmentName }</span>
