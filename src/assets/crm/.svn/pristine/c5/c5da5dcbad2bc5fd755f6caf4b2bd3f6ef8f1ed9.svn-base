...
<body class="container-fluid content">
					...
					<div class="form-horizontal row" style="padding-right: 20px;">
						...
						<div class="form-group col-md-4 col-sm-6 input-box-list">
							...
							<div class="input-box-list-value">
							 ...
							 <c:if test="${user.roleId !='8'}">
							 	<input type="text" class="form-control" id="price" name="price" value="0" disabled="disabled">
							 </c:if>
							</div>
						</div>
						<div class="form-group col-md-4 col-sm-6 input-box-list">
						...
						<div class="form-group col-md-4 col-sm-6 input-box-list">
							...
							<div class="input-box-list-value">
								<input type="text" class="form-control" id="invnum"  value="0"
									disabled>
							</div>
						</div>
						...
						<div class="form-group col-md-4 col-sm-6 input-box-list">
							...
							<div class="input-box-list-value">
								<input type="text" class="form-control goodsNum" id="num" value="0"
									name="num"  placeholder="输入产品数量">
							</div>
						</div>
						<div class="form-group col-md-4 col-sm-6 input-box-list">
							<label for="input1" class=" font12 input-box-list-title">金额(元)：</label>
							<div class="input-box-list-value">
	...
	<script type="text/javascript" src="static/js/order/addTransfer.js"></script>
	<script type="text/javascript">
