...
<form id="saveForm" class="col-md-12" enctype="multipart/form-data" style=" min-height: 200px; padding:10px 0;" action="customer/save.html" method="post">
    ...
    <div class="form-horizontal row" style="margin: 0 0 20px 0;">
        ...
        <div class="form-group col-md-8 col-sm-12 input-box-list">
            ...
            <div class="input-box-list-value">
                <input type="text" name="address" value="${custBase.address }" class="form-control" id="input_address" placeholder="公司地址">
            </div>
        </div>
        <div class="form-group col-md-4 col-sm-6 input-box-list">
        ...
        <div class="form-group col-md-4 col-sm-6 input-box-list">
            <label for="input_name" class=" font12 input-box-list-title label-base">合作盐业公司：</label>
            <input type="hidden" value="${custBase.pid }" id="customerHiddenInput">
            <div class="input-box-list-value">
                <select class="required form-control" name="pid" data-placeholder="请选择合作盐业公司信息..." id="customerSelection">
				</select>
            </div>
        </div>
    </div>
	            ...
	            <div class="bank-box">
	                <div class="page-header" style="padding: 5px 0; margin-bottom: 10px;">
	                    <h4 class="">
	                        ...
	                        <c:if test="${custBase.states eq '1'}">
