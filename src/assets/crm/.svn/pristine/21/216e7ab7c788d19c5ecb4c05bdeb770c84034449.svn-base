...
<section class="content-header">
    ...
    <div class="row  customAccount">
        ...
        <!-- <div class="col-md-5 col-xs-6 ship ">
				...
				<div class="modal-body">
					<form class="form-horizontal" method="post"
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select  style="width:100%;" tabindex="1" id="materialId" name="materialId"data-placeholder="输入SKU..." >
                            </select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="price"
									name="price" readonly="readonly" value="0">
							</div>
							<small class="help-block col-sm-3"></small>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select class="form-control" style="border-radius: 0; padding-right: 30px; " id="policy"  disabled="disabled">
                            	</select>
							</div>
							<small class="help-block col-sm-3"></small>
						</div>
				...
				<div class="modal-body">
					<form class="form-horizontal" method="post"
						...
						<div class="form-group">
							<label for="policy" class="col-sm-3 control-label">销售政策</label>
							<div class="col-sm-6">
								<select class="form-control" style="border-radius: 0; padding-right: 30px; " id="editpolicy" disabled="disabled" >
                            	</select>
							</div>
							<small class="help-block col-sm-3"></small>
						</div>
...
<script type="text/javascript" src="static/js/order/orderedit.js"></script>
