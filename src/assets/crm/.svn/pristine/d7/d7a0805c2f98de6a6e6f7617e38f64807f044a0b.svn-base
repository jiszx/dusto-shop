...
<body class="container-fluid content">
	...
	<form>
		...
		<div class="row">
			<div class="col-md-6  col-sm-6 factory-select-box">
				<p class="text-muted order-item">调拨类型:</p>
				<div class="form-group" style="width: 100%;">
					<select class="form-control" data-placeholder="请选择送达方信息..."
						style="width: 350px;" tabindex="3" id="type" name="type" disabled="disabled">
						<option value="1">合作仓储商调拨单</option>
						<option value="2">NKA物流商调拨单</option>
					</select>
				</div>
			</div>
			<div class="col-md-6  col-sm-6 factory-select-box">
		...
		<input type="hidden" id="orgid"> <input type="hidden" id="hbratio">
			...
			<div class="col-md-5 col-xs-6">
				...
				<div class="account-panel">
					...
					<p class="account-item ">
						<span class="account-title">货补余额(元):</span> <span
	...
	<script type="text/javascript" src="static/js/customerInv/specialAllocation.js"></script>
