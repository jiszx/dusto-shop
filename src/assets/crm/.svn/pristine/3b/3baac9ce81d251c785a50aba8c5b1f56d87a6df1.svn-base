...
<body class="container-fluid content">
	...
	<div class="col-md-12">
		<form class="form form-horizontal" action="combination/addOrUpdateCombination" method="POST"
			id="editCombinationForm">
			<input type="hidden" id="id" name="id" value="${h.id}">
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">套餐编码</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" id="code" name="code" value="${h.code}"
						placeholder="套餐编码" readonly="readonly">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="name" name="name" value="${h.name}"
						placeholder="套餐名称">
				</div>
				<small class="help-block col-sm-2"></small>
			</div>
			<div class="form-group hide">
				...
				<div class="col-sm-8 ">
					...
					<input type="text" class="form-control" id="price" name="price" value="${h.price/100}"
			...
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">套餐规格(g)</label>
				<div class="col-sm-8 ">
					<input type="text" class="form-control" id="weight" name="weight" value="${h.weight}"
						placeholder="套餐规格">
				</div>
				<small class="help-block col-sm-2"></small>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<select class="form-control no-appearance" id="modelType" 
						name="modelType" disabled="disabled">
						<option></option>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="date" class="form-control" id="bDate" name="bDate" value="${bdate}"
						placeholder="开始时间">
				</div>
				<div class="col-sm-4">
			...
			<div class="form-group">
				<div class="col-sm-10 text-center">
					<button type="submit" class="btn btn-primary" id="btn-edit-save" form="editCombinationForm">保存</button>
				</div>
			</div>
	</div>
	<!-- addDialog-->
	...
	<div class="modal fade" id="addPointsModal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form form-horizontal" action="combination/edit/addRebateLine" method="POST"
							id="addRebateLineForm">
						<input type="hidden" name="headerId" value="${h.id}">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label">数量限制</label>
							<div class="col-sm-8 ">
								<div class="input-group">
									<input type="text" class="form-control" id="limitNum" name="limitNum"
										value="1">
						...
						<div class="form-group">
							...
							<div class="col-sm-8 ">
								<div class="input-group">
									<input type="text" class="form-control" id="rebateRatio" name="ratio"
										value="1">
						...
						<div class="form-group hide">
							...
							<div class="col-sm-8 ">
								<div class="input-group">
									<input type="text" class="form-control" id="rebateprice" name="price"
										value="0">
									<div class="input-group-addon">%</div>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control" id="rebateMaterial" name="materialId">
								</select>
							</div>
							<div class="help-block col-sm-2"></div>
						</div>
				...
				<div class="modal-footer">
					<button type="submit" id="btn-addRbate" class="btn btn-primary" form="addRebateLineForm">确定</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				</div>
			</div>
			<!-- /.modal-content -->
	...
	<script type="text/javascript" src="static/js/combination/edit.js"></script>
</body>
</html>
